...
- **Memoria 2.0**: orchestrator SIEMPRE lee `PROJECT_STATE.md`; SUMMARY/CHANGELOG on-demand; topic upsert + stale `review_after` + búsqueda `memory-index.mjs` + sync local `memory-sync.mjs`.

## Archivos 2.0

- `.opencode/agents/orchestrator.md` — primario, routing orgánico + SDD-lite.
