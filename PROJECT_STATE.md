...
- Agente primario local orchestrator→advisor: `bin advisor` ≠ agente `advisor` local ≠ Orchestrator harness GLOBAL; migración `--upgrade` post-restorePreserved, corte limpio sin residuos [topic: architecture/agent-advisor-rename] review_after: 2027-03-04
