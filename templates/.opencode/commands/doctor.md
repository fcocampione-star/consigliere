...
Ejecuta diagnóstico del harness Consigliere 2.0. Revisa (read-only, sin editar):
...
7. Directorio: `CHANGELOG/`, `.consigliere/backups/`, `.consigliere/chunks/` existen, `.consigliere/skill-registry.cache.json` válido si existe.
